...
partial class ProductView {
    ...
    private void InitializeComponent() {
        ...
        this.txt_Qty_Desired = new Label();
        ...
        this.btn_Quit.Click += this.btn_Quit_Click;
        // 
        // tblPanel_Main
        // 
        ...
        this.pnl_SearchList.Controls.Add(this.Txt_SearchBox);
        ...
        this.Txt_SearchBox.Font = new Font("Arial", 13.8F, FontStyle.Regular, GraphicsUnit.Point);
        this.Txt_SearchBox.Location = new Point(3, 14);
        this.Txt_SearchBox.Name = "Txt_SearchBox";
        this.Txt_SearchBox.PlaceholderText = " Recherchez un Produit";
        this.Txt_SearchBox.Size = new Size(448, 34);
        this.Txt_SearchBox.TabIndex = 0;
        this.Txt_SearchBox.TextChanged += this.Txt_SearchBox_TextChanged;
        // 
        ...
        // pnl_Modify
        // 
        this.pnl_Modify.Controls.Add(this.Btn_Action);
        ...
        // Btn_Action
        // 
        this.Btn_Action.Anchor =  AnchorStyles.Left | AnchorStyles.Right;
        this.Btn_Action.Font = new Font("Arial", 13.8F, FontStyle.Regular, GraphicsUnit.Point);
        this.Btn_Action.Location = new Point(3, 13);
        this.Btn_Action.Name = "Btn_Action";
        this.Btn_Action.Size = new Size(238, 55);
        ...
        this.grpBox_Details.Controls.Add(this.txt_Qty_Desired);
        ...
        // txt_Qty_Desired
        // 
        this.txt_Qty_Desired.BackColor = SystemColors.Menu;
        this.txt_Qty_Desired.Location = new Point(155, 366);
        this.txt_Qty_Desired.Margin = new Padding(6);
        this.txt_Qty_Desired.Name = "txt_Qty_Desired";
        this.txt_Qty_Desired.Size = new Size(207, 30);
        this.txt_Qty_Desired.TabIndex = 42;
        this.txt_Qty_Desired.Text = "0";
        this.txt_Qty_Desired.TextAlign = ContentAlignment.MiddleLeft;
        // 
        // txt_Qty_InStock
        // 
